import {
  ChevronDownIcon
} from "./chunk-BM2RLKMU.js";
import {
  animate,
  style,
  transition,
  trigger
} from "./chunk-6JFBHTJY.js";
import {
  RouterLink,
  RouterLinkActive,
  RouterModule
} from "./chunk-JE64V2CJ.js";
import "./chunk-WAU5PXDM.js";
import "./chunk-32C3KHVV.js";
import {
  ButtonDirective,
  ButtonModule
} from "./chunk-VOHJ4JIN.js";
import {
  Ripple,
  RippleModule
} from "./chunk-27SWPHDL.js";
import {
  BaseIcon,
  ConnectedOverlayScrollHandler,
  DomHandler
} from "./chunk-XQT3LX3Y.js";
import {
  ObjectUtils,
  OverlayService,
  PrimeNGConfig,
...
function SplitButton_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("icon", ctx_r2.icon)("iconPos", ctx_r2.iconPos)("disabled", ctx_r2.disabled);
...
var SplitButton = class _SplitButton {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 10,
    vars: 22,
    consts: [["container", ""], ["defaultButton", ""], ["menu", ""], ["defaultbtn", ""], [3, "ngClass", "ngStyle"], [4, "ngIf", "ngIfElse"], ["type", "button", "pButton", "", 1, "p-splitbutton-menubutton", "p-button-icon-only", 3, "click", "keydown", "disabled"], [4, "ngIf"], [4, "ngTemplateOutlet"], [3, "id", "popup", "model", "styleClass", "appendTo", "showTransitionOptions", "hideTransitionOptions"], ["type", "button", "pButton", "", 1, "p-splitbutton-defaultbutton", 3, "click", "icon", "iconPos", "disabled"], ["type", "button", "pButton", "", 1, "p-splitbutton-defaultbutton", 3, "click", "icon", "iconPos", "label", "disabled"]],
    template: function SplitButton_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = ɵɵgetCurrentView();
        ɵɵelementStart(0, "div", 4, 0);
        ɵɵtemplate(2, SplitButton_ng_container_2_Template, 3, 6, "ng-container", 5)(3, SplitButton_ng_template_3_Template, 2, 6, "ng-template", null, 1, ɵɵtemplateRefExtractor);
